...
-- Pedidos de 2009
SELECT distinct codigo_pedido, codigo_cliente, fecha_pedido
from pedido
...
SELECT distinct codigo_pedido, codigo_cliente, fecha_pedido
from pedido
where extract(month from fecha_pedido)="01";

-- Pagos de 2008 por Paypal de menor a mayor
SELECT *
from pago
WHERE forma_pago="Paypal" and EXTRACT(year from fecha_pago)="2008"
ORDER BY total DESC ;
...
SELECT estado as Estado_Pedido, COUNT(*) as Pedidos_Realizados
from pedido
group by estado
order by Pedidos_Realizados desc;

-- Calcula el precio de venta del producto más caro y más barato en una misma consulta.
SELECT max(p1.precio_venta) as Max_Min
FROM producto p1
union all
